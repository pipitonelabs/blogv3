...
```yaml
# From [.github/workflows/build-k8s.yaml](https://github.com/pipitonelabs/pipitonelabs.com/blob/main/.github/workflows/build-k8s.yaml)
jobs:
  release:
...
Check out the [repository](https://github.com/pipitonelabs/pipitonelabs.com) for full configs!

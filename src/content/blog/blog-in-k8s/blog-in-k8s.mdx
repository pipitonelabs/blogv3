...
### Key Features:
- **Semantic Release**: Analyzes commit messages (e.g., `feat:`, `fix:`) to determine version bumps.
- **Docker Build**: Creates multi-platform images and pushes to GitHub Container Registry (GHCR).
...
```yaml
# From [.github/workflows/build-k8s.yml](https://github.com/pipitonelabs/blogv2/blob/main/.github/workflows/build-k8s.yml)
jobs:
  release:
...
1. Set up semantic-release in your repo.
